...
public interface TaskService extends org.apache.dubbo.rpc.model.DubboStub {
    ...
    */
    ...
    com.myz.wxapp.api.task.CancelTaskReply cancelTask(com.myz.wxapp.api.task.CancelTaskRequest request);

    default CompletableFuture<com.myz.wxapp.api.task.CancelTaskReply> cancelTaskAsync(com.myz.wxapp.api.task.CancelTaskRequest request){
        return CompletableFuture.completedFuture(cancelTask(request));
    }
    ...
    * It will not be called if you are NOT using Dubbo3 generated triple stub and <b>DO NOT</b> implement this method.
    */
    default void cancelTask(com.myz.wxapp.api.task.CancelTaskRequest request, StreamObserver<com.myz.wxapp.api.task.CancelTaskReply> responseObserver){
        cancelTaskAsync(request).whenComplete((r, t) -> {
            if (t != null) {
                responseObserver.onError(t);
            } else {
                responseObserver.onNext(r);
